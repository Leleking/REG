...
require_once(FETCH.'/fetch_received.php');
...
?>
    ...
    <li>
      <div class="collapsible-header">Last Added Received file<span style="float:right">Time: <?php echo $last_time; ?></span></div>
    ...
    <form class="col s12" id="rform" method="POST">
      ...
      <div class="input-field col s3">
       ...
       <div class="row">
        ...
        <input type='hidden' name='page_name' value='received'>
